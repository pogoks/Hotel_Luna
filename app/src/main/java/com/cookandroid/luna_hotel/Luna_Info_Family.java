...
private int hotel_number = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            image_room_01.setImageResource(R.drawable.r_seoul_2f_1);
            image_room_02.setImageResource(R.drawable.r_seoul_2f_2);
            image_room_03.setImageResource(R.drawable.r_seoul_2f_3);

        }
        else if (hotel_number == 2) // 부산
        {
            image_room_01.setImageResource(R.drawable.r_busan_2f_1);
            image_room_02.setImageResource(R.drawable.r_busan_2f_2);
            image_room_03.setImageResource(R.drawable.r_busan_2f_3);
        ...
        {
            image_room_01.setImageResource(R.drawable.r_jeju_2f_1);
            image_room_02.setImageResource(R.drawable.r_jeju_2f_2);
            image_room_03.setImageResource(R.drawable.r_jeju_2f_3);
        ...
        {
            image_room_01.setImageResource(R.drawable.r_sokcho_2f_1);
            image_room_02.setImageResource(R.drawable.r_sokcho_2f_2);
            image_room_03.setImageResource(R.drawable.r_sokcho_2f_3);
